...
export default function HoverPlayer() {
  const hoveredElement=useHoveredParagraphCoordinate(getTopLevelReadableElementsOnPage() );
  
  if(hoveredElement){
    return <div style={{position:'absolute',top:hoveredElement.top,left:hoveredElement.left,height:hoveredElement.heightOfFirstLine}} onClick={()=>{
